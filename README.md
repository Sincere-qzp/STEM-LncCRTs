# STEM-LncCRTs
We developed an integrative analytical framework combining network-based approaches with Bayesian network inference. This framework enables the robust identification of core regulatory genes, which we term STEM-LncCRTs. 
